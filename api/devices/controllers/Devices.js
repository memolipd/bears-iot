...
module.exports = {
  ...
  /**
   * Add an entry to a specific Devices.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific Devices.
   *
   * @return {Object}
   */
