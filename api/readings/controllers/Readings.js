...
/**
 * A set of functions called "actions" for `Readings`
 */

module.exports = {

  /**
   * Get Readings entries.
   *
   * @return {Object|Array}
   */
  ...
  /**
   * Add an entry to a specific Readings.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific Readings.
   *
   * @return {Object}
   */
